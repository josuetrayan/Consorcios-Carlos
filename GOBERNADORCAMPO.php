...
-------------------------------------------  -->
        ...
        <Section id="tarjetadePresentacion">
            ...
            <h2 class="expensa">Presione para Visualizar la Expensa de la gobernador campo </h2>
            <thead>
                <tr>
            ...
            <?php
        $db=new Conect_MySql();
            $sql = "select*from gobernadorcampo";
            $query = $db->execute($sql);
            ...
            <tr>
                ...
                <td class="holamunndo"><a
                        href="GOBERNADORCAMPO.php?id=<?php echo $datos['id_documento']?>"><?php echo $datos['nombre_archivo']; ?></a>
                </td>
            </tr>
        ...
        // ingresa el nombre de la tabla del esdificio
            $sql = "select*from gobernadorcampo where id_documento=".$_GET['id'];
            $query = $db->execute($sql);
