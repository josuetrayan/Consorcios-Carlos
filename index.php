...
-------------------------------------------  -->
    ...
    <section id="Slider-Principal" class="swiper-container ">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide d-flex justify-content-center " style="background-image: url(img/slider_5.jpg);  ">
            ...
            <div class="swiper-slide d-flex justify-content-center " style="background-image: url(img/slider_6.jpg);  ">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="lts_pst">
                        ...
                        <p>Carlos Trayan, administrador en Tucumán y actual presidente de la Cámara de administradores
                        ...
                        <div id='uno' style="display: none">
                            <p>
                                ...
                                muy bajo perfil, somos gente sencilla que trabaja muchas horas por día con recursos muy
                                limitados propios de una provincia del interior de un país con grandes dificultades. Y
                                ...
                                absorben el peso de la gestión diaria. Uno es la cara visible de un grupo de personas
                                que hacen un esfuerzo notable por servir y sin ellos mi
                                trabajo sería imposible” asegura Trayan, lejos de usar palabras comunes, para quienes
                                conocemos desde adentro sus oficinas.</p>
                        </div>
                        <div class="post_btn">
                            <div class="hover_effect_btn" id="hover_effect_btn">
                                <a id='boton1' onclick="Vermas('uno','boton1')" data-hover="view more post"><span>Leer
                                        Más</span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lts_pst">
                        ...
                        <div id='Dos' style="display: none">
                            <p>con un registro
                                ...
                                Trayán resalta que pretenden brindar un servicio a la comunidad no sólo trabajando con
                                los administradores, sino también “protegiendo a los consorcistas
                                para que no caigan en manos de inescrupulosos que no asumen sus responsabilidades”. Él
                                ...
                                profesionales, regulando así la actividad, ya que los errores de quienes administran sin
                                estar preparados siempre terminan perjudicando a los
                                propietarios. </p>
                        </div>
                        <div class="post_btn">
                            <div class="hover_effect_btn" id="hover_effect_btn">
                                <a id='boton2' onclick="Vermas('Dos','boton2')" data-hover="view more post"><span>Leer
                                        Más</span></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="lts_pst">
                        ...
                        <p>Gracias por confiar en mi persona . Gracias por ser un de los Miembros del Comité Ejecutivo
                            de la Federación Económica de Tucumán. Muchas gracias.</p>
                        <div class="post_btn">
                            <div class="hover_effect_btn" id="hover_effect_btn">
                                <a id='boton' onclick="Vermas('Tres','boton')" data-hover="view more post"><span>Leer
                                        Más</span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="owl-carousel owl-theme">
                        ...
                        <div class="item">
                            <div class="col-12">
                                ...
                                <h2 class="nombreTarjeta">Walter E. Trayan <br> <span class="cargoTarjeta">Maestro Mayor
                                        de Obra</span></h2>
                                <p></p>
                            </div>
                        </div>
                    ...
                    <ul class="list-unstyled">
                        <li class="d-flex border-bottom py-4">
                            ...
                            <div>
                                ...
                                <p class="contacto-parrafo mb-0">Dirección: Pasaje 2 de Abril 380 / 4º Piso / Oficina 17
                                </p>
                        </li>
