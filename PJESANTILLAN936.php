...
-------------------------------------------  -->
        ...
        <Section id="tarjetadePresentacion">
            ...
            <h2 class="expensa">Presione para Visualizar la Expensa de la pje santillan 936 </h2>
            <thead>
                <tr>
            ...
            <?php
        $db=new Conect_MySql();
            $sql = "select*from pjesantillan936";
            $query = $db->execute($sql);
            ...
            <tr>
                ...
                <td class="holamunndo"><a
                        href="PJESANTILLAN936.php?id=<?php echo $datos['id_documento']?>"><?php echo $datos['nombre_archivo']; ?></a>
                </td>
            </tr>
        ...
        // ingresa el nombre de la tabla del esdificio
            $sql = "select*from pjesantillan936 where id_documento=".$_GET['id'];
            $query = $db->execute($sql);
