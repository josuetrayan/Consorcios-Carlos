...
<head>
    ...
    <title>SANLORENZO Y HERAS</title>
...
-------------------------------------------  -->
        ...
        <Section id="tarjetadePresentacion">
            ...
            <h2 class="expensa">Presione para Visualizar la Expensa de la sanlorenzo y heras </h2>
            <thead>
                <tr>
            ...
            <?php
        $db=new Conect_MySql();
            $sql = "select*from sanlorenzoyheras";
            $query = $db->execute($sql);
            ...
            <tr>
                ...
                <td class="holamunndo"><a
                        href="SANLORENZOYHERAS.php?id=<?php echo $datos['id_documento']?>"><?php echo $datos['nombre_archivo']; ?></a>
                </td>
            </tr>
        ...
        // ingresa el nombre de la tabla del esdificio
            $sql = "select*from sanlorenzoyheras where id_documento=".$_GET['id'];
            $query = $db->execute($sql);
