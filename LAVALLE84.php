...
-------------------------------------------  -->
        ...
        <Section id="tarjetadePresentacion">
            ...
            <h2 class="expensa">Presione para Visualizar la Expensa de la lavalle 84 </h2>
            <thead>
                <tr>
        ...
        $db=new Conect_MySql();
            ...
            <tr>
                ...
                <td class="holamunndo"><a
                        href="LAVALLE84.php?id=<?php echo $datos['id_documento']?>"><?php echo $datos['nombre_archivo']; ?></a>
                </td>
            </tr>
        ...
        // ingresa el nombre de la tabla del esdificio
            $sql = "select*from lavalle84 where id_documento=".$_GET['id'];
            $query = $db->execute($sql);
