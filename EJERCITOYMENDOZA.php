...
<head>
    ...
    <title>EJERCITO Y MENDOZA</title>
...
-------------------------------------------  -->
        ...
        <Section id="tarjetadePresentacion">
            ...
            <h2 class="expensa">Presione para Visualizar la Expensa de la ejercito y mendoza </h2>
            <thead>
                <tr>
            ...
            <?php
        $db=new Conect_MySql();
            $sql = "select*from ejercitoymendoza";
            $query = $db->execute($sql);
            ...
            <tr>
                ...
                <td class="holamunndo"><a
                        href="EJERCITOYMENDOZA.php?id=<?php echo $datos['id_documento']?>"><?php echo $datos['nombre_archivo']; ?></a>
                </td>
            </tr>
        ...
        // ingresa el nombre de la tabla del esdificio
            $sql = "select*from ejercitoymendoza where id_documento=".$_GET['id'];
            $query = $db->execute($sql);
